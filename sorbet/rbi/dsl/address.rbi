...
class Address
  ...
  module GeneratedAssociationMethods
    ...
    # This method is created by ActiveRecord on the `Address` class because it declared `has_many :patients`.
    ...
    # This method is created by ActiveRecord on the `Address` class because it declared `has_many :users`.
    # 🔗 [Rails guide for `has_many` association](https://guides.rubyonrails.org/association_basics.html#the-has-many-association)
